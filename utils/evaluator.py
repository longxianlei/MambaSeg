...
class Evaluator():
    ...
    def __init__(self, cfg):
        ...
        num_channels_ev = self.cfg['DATASET']['nr_bins'] * 2 if self.cfg['DATASET']['event_representation'] == 'AET' else self.cfg['DATASET']['nr_bins']
        
        # self.model = MMNet(ver_img=self.cfg['MODEL']['version_img'], 
        #             num_classes=self.cfg['DATASET']['classes'], 
        #             rep=self.cfg['MODEL']['event_rep'], 
        #             num_channels_img=self.cfg['DATASET']['img_chnls'], 
        #             pretrained_img=None, 
        #             num_channels_ev=num_channels_ev, 
        #             pretrained_ev=None,
        #             fuse=self.cfg['MODEL']['fuse'],
        #             data_type=self.cfg['DATASET']['data_type'],
        #             img_size=self.cfg['DATASET']['img_size'],
        #             embed_out=self.cfg['MODEL']['embed_out'],
        #             if_viz=False)
